...
.field private l:Landroid/support/v7/widget/br;
...
.method public c()Landroid/support/v7/widget/br;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/br;
...
.method public d()Z
    ...
    invoke-direct {v2, v3, v4, v5, v6}, Landroid/support/v7/widget/br;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object v2, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/br;

    iget-object v2, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/br;

    invoke-virtual {v2, p0}, Landroid/support/v7/widget/br;->a(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v2, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/br;

    invoke-virtual {v2, p0}, Landroid/support/v7/widget/br;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v2, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/br;

    iget-object v3, p0, Landroid/support/v7/view/menu/v;->f:Landroid/support/v7/view/menu/w;

    invoke-virtual {v2, v3}, Landroid/support/v7/widget/br;->a(Landroid/widget/ListAdapter;)V

    iget-object v2, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/br;

    invoke-virtual {v2, v1}, Landroid/support/v7/widget/br;->a(Z)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/br;->a(Landroid/view/View;)V

    iget-object v0, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/br;

    iget v2, p0, Landroid/support/v7/view/menu/v;->r:I

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/br;->d(I)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/br;->f(I)V

    iget-object v0, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/br;

    const/4 v2, 0x2

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/br;->g(I)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/br;->m()Landroid/widget/ListView;
...
.method public onDismiss()V
    ...
    iput-object v1, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/br;
