...
.field private final d:Landroid/support/v7/widget/bp;
...
.field private k:Landroid/support/v7/widget/br;
...
.method private a(I)V
    ...
    :goto_2
    invoke-direct {p0}, Landroid/support/v7/widget/ActivityChooserView;->getListPopupWindow()Landroid/support/v7/widget/br;
    ...
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/br;->f(I)V

    invoke-virtual {v3}, Landroid/support/v7/widget/br;->c()V
    ...
    :cond_2
    invoke-virtual {v3}, Landroid/support/v7/widget/br;->m()Landroid/widget/ListView;
...
.method private getListPopupWindow()Landroid/support/v7/widget/br;
    .locals 2

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->k:Landroid/support/v7/widget/br;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->k:Landroid/support/v7/widget/br;

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->k:Landroid/support/v7/widget/br;

    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView;->b:Landroid/support/v7/widget/ag;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/br;->a(Landroid/widget/ListAdapter;)V

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->k:Landroid/support/v7/widget/br;

    invoke-virtual {v0, p0}, Landroid/support/v7/widget/br;->a(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/br;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->k:Landroid/support/v7/widget/br;

    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView;->c:Landroid/support/v7/widget/ah;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/br;->a(Landroid/widget/PopupWindow$OnDismissListener;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->d:Landroid/support/v7/widget/bp;

    sub-int v1, p4, p2

    sub-int v2, p5, p3

    invoke-virtual {v0, v3, v3, v1, v2}, Landroid/support/v7/widget/bp;->layout(IIII)V
