...
.method public run()V
    ...
    invoke-virtual {v1, v2}, Landroid/support/v4/h/db;->b(F)Landroid/support/v4/h/db;

    move-result-object v1

    iget-object v2, p0, Landroid/support/v7/widget/g;->a:Landroid/support/v7/widget/ActionBarOverlayLayout;

    invoke-static {v2}, Landroid/support/v7/widget/ActionBarOverlayLayout;->b(Landroid/support/v7/widget/ActionBarOverlayLayout;)Landroid/support/v4/h/ds;

    move-result-object v2

    invoke-virtual {v1, v2}, Landroid/support/v4/h/db;->a(Landroid/support/v4/h/ds;)Landroid/support/v4/h/db;

    move-result-object v1

    invoke-static {v0, v1}, Landroid/support/v7/widget/ActionBarOverlayLayout;->a(Landroid/support/v7/widget/ActionBarOverlayLayout;Landroid/support/v4/h/db;)Landroid/support/v4/h/db;
