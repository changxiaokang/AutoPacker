...
.method private constructor <init>(Landroid/support/v7/widget/Toolbar;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/de;->c:Landroid/support/v7/widget/Toolbar;
...
.method synthetic constructor <init>(Landroid/support/v7/widget/Toolbar;Landroid/support/v7/widget/db;)V
    .locals 0

    invoke-direct {p0, p1}, Landroid/support/v7/widget/de;-><init>(Landroid/support/v7/widget/Toolbar;)V
...
.method public a(Landroid/content/Context;Landroid/support/v7/view/menu/i;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/de;->a:Landroid/support/v7/view/menu/i;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/de;->b:Landroid/support/v7/view/menu/m;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/de;->a:Landroid/support/v7/view/menu/i;

    iget-object v1, p0, Landroid/support/v7/widget/de;->b:Landroid/support/v7/view/menu/m;

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/i;->d(Landroid/support/v7/view/menu/m;)Z

    :cond_0
    iput-object p2, p0, Landroid/support/v7/widget/de;->a:Landroid/support/v7/view/menu/i;
...
.method public a(Landroid/support/v7/view/menu/i;Landroid/support/v7/view/menu/m;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/de;->c:Landroid/support/v7/widget/Toolbar;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/de;->c:Landroid/support/v7/widget/Toolbar;
    ...
    iput-object p2, p0, Landroid/support/v7/widget/de;->b:Landroid/support/v7/view/menu/m;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/Toolbar;->i()Landroid/support/v7/widget/df;

    move-result-object v0

    const v1, 0x800003

    iget-object v2, p0, Landroid/support/v7/widget/de;->c:Landroid/support/v7/widget/Toolbar;
...
.method public b(Z)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/de;->a:Landroid/support/v7/view/menu/i;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/de;->a:Landroid/support/v7/view/menu/i;

    invoke-virtual {v3, v1}, Landroid/support/v7/view/menu/i;->getItem(I)Landroid/view/MenuItem;

    move-result-object v3

    iget-object v4, p0, Landroid/support/v7/widget/de;->b:Landroid/support/v7/view/menu/m;
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/de;->b(Landroid/support/v7/view/menu/i;Landroid/support/v7/view/menu/m;)Z
...
.method public b(Landroid/support/v7/view/menu/i;Landroid/support/v7/view/menu/m;)Z
    ...
    iput-object v2, p0, Landroid/support/v7/widget/de;->b:Landroid/support/v7/view/menu/m;
