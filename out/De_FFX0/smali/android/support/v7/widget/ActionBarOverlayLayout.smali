...
.field private w:Landroid/support/v4/widget/aq;

.field private x:Landroid/support/v4/h/db;

.field private final y:Landroid/support/v4/h/ds;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->y:Landroid/support/v4/h/ds;
...
.method static synthetic a(Landroid/support/v7/widget/ActionBarOverlayLayout;Landroid/support/v4/h/db;)Landroid/support/v4/h/db;
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->x:Landroid/support/v4/h/db;
...
.method private a(Landroid/content/Context;)V
    ...
    invoke-static {p1}, Landroid/support/v4/widget/aq;->a(Landroid/content/Context;)Landroid/support/v4/widget/aq;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Landroid/support/v4/widget/aq;
...
.method private a(FF)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Landroid/support/v4/widget/aq;
    ...
    invoke-virtual/range {v0 .. v8}, Landroid/support/v4/widget/aq;->a(IIIIIIII)V

    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Landroid/support/v4/widget/aq;

    invoke-virtual {v0}, Landroid/support/v4/widget/aq;->d()I
...
.method static synthetic b(Landroid/support/v7/widget/ActionBarOverlayLayout;)Landroid/support/v4/h/ds;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->y:Landroid/support/v4/h/ds;
...
.method private k()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->x:Landroid/support/v4/h/db;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v2}, Landroid/support/v4/h/bo;->f(Landroid/view/View;)F
...
.method protected fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0}, Landroid/support/v4/h/bo;->i(Landroid/view/View;)I
    ...
    invoke-static {p0, v1, v2}, Landroid/support/v7/widget/dn;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method public getActionBarHideOffset()I
    ...
    invoke-static {v0}, Landroid/support/v4/h/bo;->f(Landroid/view/View;)F
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-static {p0}, Landroid/support/v4/h/bo;->j(Landroid/view/View;)V
...
.method protected onMeasure(II)V
    ...
    invoke-static {v9, v2}, Landroid/support/v7/widget/dn;->a(II)I
