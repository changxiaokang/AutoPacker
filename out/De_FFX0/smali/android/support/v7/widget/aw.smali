...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/aw;->a:Landroid/support/v7/widget/cy;

    new-instance v0, Landroid/support/v7/widget/an;

    iget-object v1, p0, Landroid/support/v7/widget/aw;->a:Landroid/support/v7/widget/cy;

    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/an;-><init>(Landroid/widget/CompoundButton;Landroid/support/v7/widget/cy;)V

    iput-object v0, p0, Landroid/support/v7/widget/aw;->b:Landroid/support/v7/widget/an;

    iget-object v0, p0, Landroid/support/v7/widget/aw;->b:Landroid/support/v7/widget/an;
...
.method public getCompoundPaddingLeft()I
    ...
    iget-object v1, p0, Landroid/support/v7/widget/aw;->b:Landroid/support/v7/widget/an;
...
.method public setButtonDrawable(I)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/aw;->a:Landroid/support/v7/widget/cy;
    ...
    :goto_0
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/aw;->setButtonDrawable(Landroid/graphics/drawable/Drawable;)V
