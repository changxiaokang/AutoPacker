...
.method public static a(Ljava/lang/Object;Landroid/view/View;Ljava/util/ArrayList;Ljava/util/Map;Landroid/view/View;)Ljava/lang/Object;
    ...
    invoke-static {p2, p1}, Landroid/support/v4/a/am;->b(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-static {v0, p2}, Landroid/support/v4/a/am;->b(Ljava/lang/Object;Ljava/util/ArrayList;)V
...
.method private static a(Landroid/transition/Transition;Landroid/support/v4/a/ar;)V
    .locals 1

    if-eqz p0, :cond_0

    new-instance v0, Landroid/support/v4/a/ap;

    invoke-direct {v0, p1}, Landroid/support/v4/a/ap;-><init>(Landroid/support/v4/a/ar;)V
...
.method public static a(Landroid/view/View;Landroid/view/View;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    new-instance v0, Landroid/support/v4/a/aq;
...
.method public static a(Ljava/lang/Object;Landroid/view/View;)V
    ...
    invoke-static {p1}, Landroid/support/v4/a/am;->c(Landroid/view/View;)Landroid/graphics/Rect;

    move-result-object v0

    new-instance v1, Landroid/support/v4/a/an;

    invoke-direct {v1, v0}, Landroid/support/v4/a/an;-><init>(Landroid/graphics/Rect;)V
...
.method public static a(Ljava/lang/Object;Landroid/view/View;Ljava/util/Map;Ljava/util/ArrayList;)V
    ...
    invoke-static {v2, v0}, Landroid/support/v4/a/am;->a(Ljava/util/List;Landroid/view/View;)V
    ...
    invoke-static {p0, p3}, Landroid/support/v4/a/am;->b(Ljava/lang/Object;Ljava/util/ArrayList;)V
...
.method public static a(Ljava/lang/Object;Ljava/lang/Object;Landroid/view/View;Landroid/support/v4/a/as;Landroid/view/View;Landroid/support/v4/a/ar;Ljava/util/Map;Ljava/util/ArrayList;Ljava/util/Map;Ljava/util/Map;Ljava/util/ArrayList;)V
    .locals 11
    ...
    invoke-static {p1, p4, v0, v1}, Landroid/support/v4/a/am;->a(Ljava/lang/Object;Landroid/view/View;Ljava/util/Map;Ljava/util/ArrayList;)V
    ...
    new-instance v2, Landroid/support/v4/a/ao;
    ...
    invoke-direct/range {v2 .. v9}, Landroid/support/v4/a/ao;-><init>(Landroid/view/View;Landroid/transition/Transition;Landroid/view/View;Landroid/support/v4/a/as;Ljava/util/Map;Ljava/util/Map;Ljava/util/ArrayList;)V
    ...
    invoke-static {v4, v0}, Landroid/support/v4/a/am;->a(Landroid/transition/Transition;Landroid/support/v4/a/ar;)V
...
.method public static a(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    invoke-static {v2, p1}, Landroid/support/v4/a/am;->a(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    :cond_0
    invoke-static {p0}, Landroid/support/v4/a/am;->a(Landroid/transition/Transition;)Z
...
.method static synthetic a(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-static {p0, p1}, Landroid/support/v4/a/am;->b(Ljava/util/ArrayList;Landroid/view/View;)V
...
.method private static a(Ljava/util/List;Landroid/view/View;)V
    ...
    invoke-static {p0, p1, v2}, Landroid/support/v4/a/am;->a(Ljava/util/List;Landroid/view/View;I)Z
    ...
    invoke-static {p0, v5, v2}, Landroid/support/v4/a/am;->a(Ljava/util/List;Landroid/view/View;I)Z
...
.method public static a(Ljava/util/Map;Landroid/view/View;)V
    ...
    invoke-static {p0, v2}, Landroid/support/v4/a/am;->a(Ljava/util/Map;Landroid/view/View;)V
...
.method private static a(Landroid/transition/Transition;)Z
    ...
    invoke-static {v0}, Landroid/support/v4/a/am;->a(Ljava/util/List;)Z
...
.method static synthetic b(Landroid/view/View;)Landroid/graphics/Rect;
    ...
    invoke-static {p0}, Landroid/support/v4/a/am;->c(Landroid/view/View;)Landroid/graphics/Rect;
...
.method public static b(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    invoke-static {v2, p1}, Landroid/support/v4/a/am;->b(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    invoke-static {v1}, Landroid/support/v4/a/am;->a(Ljava/util/List;)Z
...
.method private static b(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-static {p0, v2}, Landroid/support/v4/a/am;->b(Ljava/util/ArrayList;Landroid/view/View;)V
